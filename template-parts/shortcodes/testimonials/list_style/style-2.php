...
if( $show_title && $show_title == 'true' && $title && $title != '' ){
	?>
				...
				<div class="client-image">
					...
					<div>
						<div class="author-photo">
							<img class="img-responsive" src="<?php echo esc_url($testimonials_img_src);?>" alt="<?php echo esc_attr($testimonials_img_alt);?>" />
						</div>
					</div>
				</div>
