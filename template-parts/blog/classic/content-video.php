...
if( $video_type == 'youtube' && !$post_format_video_youtube ){
	$post_class = 'post-no-image';
}else if( $video_type == 'vimeo' && !$post_format_video_vimeo ){
	$post_class = 'post-no-image';
}
		...
		if( $video_type == 'html5' ) {
			...
			<div class="blog-entry-vimeo">
				<div class="js-video [vimeo, widescreen]">
					<iframe src="<?php echo esc_url($src);?>" frameborder="0" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen=""></iframe>
				</div>
			</div>
			<?php
		}
