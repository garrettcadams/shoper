...
if( 
	( isset($ciyashop_options['comming_soon_newsletter']) && $ciyashop_options['comming_soon_newsletter'] == 1 )
	&& ( ciyashop_check_plugin_active('mailchimp-for-wp/mailchimp-for-wp.php') )
	&& ( isset($ciyashop_options['comming_page_newsletter_shortcode']) && !empty($ciyashop_options['comming_page_newsletter_shortcode']) )
){
