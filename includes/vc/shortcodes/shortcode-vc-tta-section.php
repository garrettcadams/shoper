...
function ciyashop_extend_vc_tta_tour_template( $html, $atts, $content, $that ){
	if( isset($atts['tab_position']) ){
		if( $atts['tab_position'] == 'left' || $atts['tab_position'] == 'right' ){
			if( isset($atts['pgs_icon_alignment_top_bottom']) && $atts['pgs_icon_alignment_top_bottom'] == 'true' ){
				$html[0] = '<div class="vc_tta-tabs-container pgs_icon_alignment_top_bottom">';
			}
		}elseif( $atts['tab_position'] == 'top' || $atts['tab_position'] == 'bottom' ){
			if( isset($atts['pgs_full_width_tabs']) && $atts['pgs_full_width_tabs'] == 'true' ){
