...
$icon_fontawesome = $icon_linecons = $icon_openiconic = $icon_typicons = $icon_entypo = $pgscore_vc_message_hide_icon = $pgscore_vc_message_closeable = '';
...
$close_icon = false;
if( isset($pgscore_vc_message_closeable) && trim($pgscore_vc_message_closeable) != false && $pgscore_vc_message_closeable = 'true' ){
	$close_icon = true;
	$elementClass[] = 'alert';
}

$icon_stat = true;
if( isset($pgscore_vc_message_hide_icon) && $pgscore_vc_message_hide_icon == 'true' ){
	$icon_stat = false;
