(function($){
	...
	jQuery(document).ready(function($) {
		...
		templates_lazyloader();
		function templates_lazyloader() {

			var templates = document.querySelectorAll('.vc_edit-form-tab[data-tab="cs_vc_templates"] .vc_ui-template-list > .vc_ui-template');
			...
			if ( templates.length >= 0 ) {
				...
				var observer = new IntersectionObserver( function (entries, observer) {
					...
					entries.forEach(function(entry) {
						...
						if ( entry.isIntersecting && thumbImage ) {
