...
if($ciyashop_options['quick_view_product_link']==1){
...
?>
<div itemscope itemtype="<?php echo esc_attr(woocommerce_get_product_schema());?>" id="product-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
			...
			<?php
				if ( has_post_thumbnail() ) {		
					...
					$placeholder_img_src = sprintf(
						...
						esc_html__( 'Placeholder', 'ciyashop' )
					);
