				...
				<div class="box-authentication">                    
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<a href="<?php echo esc_url(get_permalink( get_option('woocommerce_myaccount_page_id') )); ?>" title="<?php esc_attr_e( 'Register', 'ciyashop' ); ?>" class="btn btn-primary"><?php esc_html_e( 'Create an account', 'ciyashop' ); ?></a>
						</div>
					</div>
